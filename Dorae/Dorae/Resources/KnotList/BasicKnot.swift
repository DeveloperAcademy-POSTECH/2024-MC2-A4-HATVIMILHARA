...
let 두벌매화 = BasicKnot(knotName: .두벌매화매듭, loop: Array(repeating: "", count: 2))
let 세벌매화 = BasicKnot(knotName: .세벌매화매듭, loop: Array(repeating: "", count: 3))
let 두벌국화 = BasicKnot(knotName: .두벌국화매듭, loop: Array(repeating: "", count: 3))
let 세벌국화 = BasicKnot(knotName: .세벌국화매듭, loop: Array(repeating: "", count: 5))
let 네벌국화 = BasicKnot(knotName: .네벌국화매듭, loop: Array(repeating: "", count: 7))
let 다섯벌국화 = BasicKnot(knotName: .다섯벌국화매듭, loop: Array(repeating: "", count: 9))
